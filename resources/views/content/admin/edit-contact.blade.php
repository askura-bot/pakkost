...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-6">Edit Contact</h2>
        ...
        <form action="{{ route('contacts.update', $contact) }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="no_wa" value="{{ old('no_wa', $contact->no_wa) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="facebook" value="{{ old('facebook', $contact->facebook) }}"
                        class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                </div>
